...
description: This section provides an overview of how DocuBook handles links and images in Markdown.
date: 14-12-2024
---

In DocuBook, all links and images written in Markdown are automatically converted to their respective Next.js components. This allows for better optimization and performance in your application.
